...
drawCircle({
     center: p(4,-2), radius: 2, strokeWidth: 5,
})
drawCircle({
     center: p(1,-1), radius: 2, strokeWidth: 5,
})
drawLabel({
    point: p(4,-2),
    pointShift: [-0.4, -2.4],
    label: "\\text{reflection point}",
    orientation: "left",
})
...
// label( p(nl-0.5,-2),"\\text{reflection line}")
