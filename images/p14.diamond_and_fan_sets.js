...
// fan set
drawPath('++----', {stroke: PINK, strokeWidth: 2})
// my line
drawPath('++--++', {stroke: BLUE, strokeWidth: 3})


drawCircle({
     center: p(4,0), radius: 2, strokeWidth: 5,
})
//labels
generate() // here b/c of cover up
drawWall({ // cover up box
    points: [p(5, 3), p(5, 3)],
    stroke: "white",
    strokeWidth: 20,
})
var shift1 = [1.7, -0.9]
curlyBraceSuper(p(0, 2), p(4, 2), shift1, "diamond set", [7.7, 0.55])
curlyBraceSuper(p(4, 2), p(6, 2), shift1, "fan set", [5.3, 0.55])
